// RemindersMenuSheet.swift
// Displays the Reminders menu sheet with a list of cards, add button, and delete functionality.
...
struct RemindersMenuSheet: View {
    ...
    // MARK: - Main View
    // The main body of the RemindersMenuSheet
    var body: some View {
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        LazyVStack(spacing: 12) {
                            // ForEach displays each card in the Reminders menu
...
#Preview {
    RemindersMenuSheet(
        menu: .reminders,
        cardsByMenu: .constant([.reminders: [Card(id: UUID(), name: "Sample Reminder", menu: .reminders, created: Date())]]),
