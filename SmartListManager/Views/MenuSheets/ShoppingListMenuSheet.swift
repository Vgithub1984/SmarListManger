// ShoppingListMenuSheet.swift
// Displays the Shopping List menu sheet with a list of cards, add button, and delete functionality.
...
struct ShoppingListMenuSheet: View {
    ...
    // MARK: - Main View
    // The main body of the ShoppingListMenuSheet
    var body: some View {
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        LazyVStack(spacing: 12) {
                            // ForEach displays each card in the Shopping List menu
...
#Preview {
    ShoppingListMenuSheet(
        menu: .shopping,
        cardsByMenu: .constant([.shopping: [Card(id: UUID(), name: "Sample Shopping Item", menu: .shopping, created: Date())]]),
