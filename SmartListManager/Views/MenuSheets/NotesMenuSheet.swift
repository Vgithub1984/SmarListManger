// NotesMenuSheet.swift
// Displays the Notes menu sheet with a list of cards, add button, and delete functionality.
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        LazyVStack(spacing: 12) {
                            // ForEach displays each card in the Notes menu
...
#Preview {
    NotesMenuSheet(
        menu: .notes,
        cardsByMenu: .constant([.notes: [Card(id: UUID(), name: "Sample Note", menu: .notes, created: Date())]]),
